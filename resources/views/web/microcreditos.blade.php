        ...
        <article class="col-sm-3" style="z-index: 4">
            <div class="d-flex justify-content-center align-items-center h-100 margin-right-mobile" style="margin-right: -175px;">
                <div data-aos="fade-right" class="px-5 py-4 bg-white w-sm-100" style="box-shadow: 10px 11px 8px -5px rgba(0,0,0,0.36); width: 350px">
                    <img width="65px" src="{{ asset('img/iconomicrocreditos.png') }}" alt="creditos de consumo hipotecario">
                    <h2 class="mt-2" style="font-family: 'Bitter', 'serif'; color: #676667; font-weight: 600">Microcréditos</h2>
                </div>
            </div>
        </article>
        <article class="col-sm-9 d-none-mobile">
            <div class="position-relative">
                ...
                <div class="position-absolute text-center top-50 start-50 translate-middle w-100">
                    <p class="h3 text-white w-100" style="font-family: 'Bitter', 'serif'; font-style: italic">¡Construye tu hogar, construye tus sueños!</p>
    ...
    <section class="row py-3">
        <article class="col-sm-6 mb-5" data-aos="fade-in">
            <div class="d-flex gap-4">
                ...
                <div>
                    <h3 class="text-danger" style="font-family: 'Bitter', 'serif'; font-weight: 600">Proceso simplificado</h3>
                    <p class="text-muted" style="font-size: medium">En el proceso de solicitud y aprobación tiende a ser más simple y ágil. Las evaluaciones de riesgo suelen basarse en la capacidad y voluntad de pago, más que en el historial crediticio.</p>
                </div>
            </div>
        </article>
        <article class="col-sm-6 mb-5" data-aos="fade-in">
            <div class="d-flex gap-4">
                ...
                <div>
                    <h3 class="text-danger" style="font-family: 'Bitter', 'serif'; font-weight: 600">Pequeñas cantidades</h3>
                    <p>Suelen ser préstamos de cantidades relativamente pequeñas, diseñados para cubrir necesidades específicas, como la compra de inventario, herramientas o maquinaria.</p>
                </div>
            </div>
        </article>
        <article class="col-sm-6 mb-5" data-aos="fade-in">
            <div class="d-flex gap-4">
                ...
                <div>
                    ...
                    <p>Tienen un enfoque social al empoderar a individuos o comunidades, fomentando el espíritu empresarial y contribuyendo al desarrollo económico.</p>
                </div>
            </div>
        </article>
        <article class="col-sm-6 mb-5" data-aos="fade-in">
            <div class="d-flex gap-4">
                ...
                <div>
                    <h3 class="text-danger" style="font-family: 'Bitter', 'serif'; font-weight: 600">Destinado a emprendedores</h3>
                    <p>Dirigidos a personas que buscan iniciar o mejorar pequeños negocios. Los receptores suelen ser emprendedores de bajos recursos que no tienen acceso a servicios financieros tradicionales.</p>
                </div>
            </div>
        </article>
    </section>
