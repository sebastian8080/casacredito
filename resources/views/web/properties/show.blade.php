            ...
            <div class="carousel-inner">
                @foreach($images as $index => $image)
                    <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                        <img style="object-fit: contain !important" src="http://127.0.0.1:8001/uploads/listing/{{$image}}" @if($index > 0) loading="lazy" @endif class="d-block w-100 carousel-image" alt="Property Image">
                    </div>
                @endforeach
            </div>
