        ...
        <article class="col-sm-3" style="z-index: 4">
            <div class="d-flex justify-content-center align-items-center h-100 margin-right-mobile" style="margin-right: -175px;">
                <div class="px-5 py-4 bg-white w-sm-100" style="box-shadow: 10px 11px 8px -5px rgba(0,0,0,0.36); width: 350px">
                    ...
                    <h2 class="mt-2" style="font-family: 'Bitter', 'serif'; color: #676667; font-weight: 600">Créditos <br> de construcción</h2>
                </div>
            </div>
        </article>
...
<section class="container">
    <section class="row py-3">
        <p style="font-family: 'Montserrat', 'serif'; text-align: justify">Los créditos de construcción son una opción para aquellas personas que desean construir su vivienda según sus necesidades y preferencias, brindando financiamiento a lo largo de las distinas etapas del proceso constructivo.</p>
    </section>
    <section class="row py-3">
        <article class="col-sm-6 mb-4">
            <div class="d-flex gap-4">
                ...
                <div>
                    <h3 class="text-danger" style="font-family: 'Bitter', 'serif'; font-weight: 600">Proceso de aprobación</h3>
                    <p class="text-muted" style="font-size: medium">Las entidades financieras suelen requerir información detallada sobre ingresos, gastos y deudas existentes.</p>
                </div>
            </div>
        </article>
        <article class="col-sm-6 mb-4">
            <div class="d-flex gap-4">
                ...
                <div>
                    ...
                    <p>En muchos casos, el crédito de construcción se otorga sin la necesidad de proporcionar garantías reales.</p>
                </div>
            </div>
        </article>
        <article class="col-sm-6 mb-4">
            <div class="d-flex gap-4">
                ...
                <div>
                    ...
                    <p>El monto del crédito y el plazo para su pago suelen variar según la política de la entidad financiera y la capacidad de pago del solicitante.</p>
                </div>
            </div>
        </article>
        <article class="col-sm-6 mb-4">
            <div class="d-flex gap-4">
                ...
                <div>
                    ...
                    <p>Algunos créditos ofrecen opciones de pagos adicionales o la posibilidad de adelantar cuotas, brindando cierta flexibilidad al deudor.</p>
                </div>
            </div>
        </article>
    </section>
