        ...
        <article class="col-sm-9 d-none-mobile">
            <div class="position-relative">
                ...
                <div class="position-absolute text-center top-50 start-50 translate-middle w-100">
                    <p class="h3 text-white w-100" style="font-family: 'Bitter', 'serif'; font-style: italic">¡Compra tu casa, crea tu historia!</p>
        ...
        <article class="col-sm-6 mb-4" data-aos="fade-in">
            <div class="d-flex gap-4">
                ...
                <div>
                    ...
                    <p class="text-muted" style="font-size: medium">Pueden destinarse tanto a fines de consumo personal como a la adquisición o mejora de una vivienda.</p>
                </div>
            </div>
        </article>
        <article class="col-sm-6 mb-4" data-aos="fade-in">
            <div class="d-flex gap-4">
                ...
                <div>
                    ...
                    <p>Cuentan con una garantía respaldada por una hipoteca sobre una propiedad inmueble. Esto brinda seguridad adicional a la entidad financiera.</p>
                </div>
            </div>
        </article>
        <article class="col-sm-6 mb-4" data-aos="fade-in">
            <div class="d-flex gap-4">
                ...
                <div>
                    <h3 class="text-danger" style="font-family: 'Bitter', 'serif'; font-weight: 600">Riesgos y Beneficios</h3>
                    <p>Los solicitantes deben considerar cuidadosamente los riesgos y beneficios de este tipo de crédito, ya que la garantía hipotecaria implica la posibilidad de perder la propiedad en caso de incumplimiento.</p>
                </div>
            </div>
        </article>
        <article class="col-sm-6 mb-4" data-aos="fade-in">
