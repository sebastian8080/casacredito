...
@section('head')
    <meta name="description"
        content="Explora las exclusivas ventajas del crédito VIP de Casa Crédito, diseñado para clientes que buscan financiamiento premium con ahorro programado, aprobación rápida, y acceso a un préstamo digital con banco abierto hoy.">
    <meta name="keywords"
        content="crédito VIP, préstamo premium, ahorro programado, banco abierto hoy, contrato de préstamo, solicitud de crédito, tabla de amortización simulador, carta de solicitud de crédito pdf, tabulador de préstamo, préstamo digital banco general">
    <meta name="author" content="Casa Crédito">
    <meta property="og:title" content="Crédito VIP fácil y seguro | Casa Crédito">
    <meta property="og:description"
        content="Descubre el crédito VIP de Casa Crédito, ideal para clientes exigentes que necesitan soluciones rápidas y eficientes como la carta de solicitud de crédito en pdf y un tabulador de préstamos personalizado.">
    <meta property="og:image" content="{{ asset('img/banner1-creditos.jpg') }}">
    <meta property="og:url" content="https://casacredito.com/credito-vip">
...
@section('content')
            ...
            <article class="col-sm-3" style="z-index: 4">
                <div class="d-flex justify-content-center align-items-center h-100 margin-right-mobile"
                    ...
                    <div class="px-5 py-4 bg-white w-sm-100"
                        style="box-shadow: 10px 11px 8px -5px rgba(0,0,0,0.36); width: 300px">
            ...
            <article class="col-sm-9 d-none-mobile">
                <div class="position-relative">
                    ...
                    <div class="position-absolute text-center top-50 start-50 translate-middle">
                        <p class="h3 text-white" style="font-family: 'Bitter', 'serif'; font-style: italic">¡Compra tu casa,
                            crea tu historia!</p>
    ...
    <section class="container">
        <section class="row py-3">
            <p style="font-family: 'Montserrat', 'serif'; text-align: justify">Aunque este término a menudo se usa para
                exclusividad, en este contexto significa Vivienda de Ínteres Público. Se refiere a viviendas que, por ser la
                primera propiedad del comprador, pueden acceder a un crédito preferncial con una tasa efectiva mínima del
                4.58% anual. Para esto, la vivienda debe tener un avalúo de $85.000 hasta $105.000- El préstamo puede
                utilizarse para financiar hasta el 95% del valor de la vivienda a un plazo máximo de 25 años. Está permitido
                hacer abonos y precancelaciones. Bajo estas condiciones, tu cuota mensual de pago para un crédito VIP
                dependerá del valor del inmueble que elijas. Lo que se busca es que el valor mensual sea similar al de un
                arriendo y así inviertas en tu propia vivienda.</p>
        </section>
        <section class="row py-3">
            <article class="col-sm-6 mb-4">
                <div class="d-flex gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-muted" style="font-size: medium">Una tasa muy baja de interés anual, el plazo de
                            financiamiento debe ser entre 20 y 25 años y solo se requiere el 5% del valor de la entrada.</p>
                    </div>
                </div>
            </article>
            <article class="col-sm-6 mb-4">
                <div class="d-flex gap-4">
                    ...
                    <div>
                        <h3 class="text-danger" style="font-family: 'Bitter', 'serif'; font-weight: 600">Ingresos mensuales
                        </h3>
                        <p>El valor del núcleo familiar no puede superar los $2.853. Bajo relación de dependencia se hace el
                            cálculo con base en los ingresos brutos; mientras que, quienes son independientes se calcula con
                            los ingresos netos mensuales.</p>
                    </div>
                </div>
            </article>
            <article class="col-sm-6 mb-4">
