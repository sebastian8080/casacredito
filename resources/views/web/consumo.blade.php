...
@section('head')
    <meta name="description"
        content="Obtén créditos de consumo flexibles y seguros con Casa Crédito. Soluciones rápidas de financiamiento personal para enfrentar gastos imprevistos o realizar compras importantes.">
    <meta name="keywords"
        content="crédito de consumo, préstamos personales, financiamiento rápido, créditos en línea, tasas de interés bajas, crédito fácil, aprobación rápida, préstamo sin garantía, Ecuador">
    <meta name="author" content="Casa Crédito">
    <meta property="og:title" content="Créditos de Consumo Fáciles y Seguros | Casa Crédito">
    <meta property="og:description"
        content="Accede a créditos de consumo que se adaptan a tus necesidades y te permiten gestionar tus finanzas personales de manera efectiva. Aprobación rápida y términos claros con Casa Crédito.">
    <meta property="og:image" content="{{ asset('img/banner1-creditos.jpg') }}">
    <meta property="og:url" content="https://www.casacredito.com/creditos-de-consumo">
...
@section('content')
            ...
            <article class="col-sm-3" style="z-index: 4">
                <div class="d-flex justify-content-center align-items-center h-100 margin-right-mobile"
                    ...
                    <div class="px-5 py-4 bg-white w-sm-100"
                        ...
                        <h2 style="font-family: 'Bitter', 'serif'; color: #676667; font-weight: 600">Créditos <br> de
                            consumo</h2>
                    </div>
                </div>
            </article>
            <article class="col-sm-9 d-none-mobile">
                <div class="position-relative">
                    ...
                    <div class="position-absolute text-center top-50 start-50 translate-middle">
                        <p class="h3 text-white" style="font-family: 'Bitter', 'serif'; font-style: italic">¡Tu camino hacia
                            el éxito financiero!</p>
    ...
    <section class="container">
        <section class="row py-3">
            <p style="font-family: 'Montserrat', 'serif'; text-align: justify">El crédito de consumo es un tipo de préstamo
                otorgado por entidades financieras a personas con el fin de cubrir necesidades personales, como la compra de
                bienes o servicios no vinculados a actividades comerciales o productivas. Es crucial entender las
                condiciones y términos del crédito de consumo antes de solicitarlo, así como asegurarse de tener la
                capacidad financiera para cumplir con los pagos establecidos.</p>
        </section>
        <section class="row py-3">
            <article class="col-sm-6 mb-4">
                <div class="d-flex gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-muted" style="font-size: medium">Puedes utilizarlo para diversos propósitos, como la
                            compra de electrodomésticos, la realización de viajes, la consolidación de deudas, entre otros.
                        </p>
                    </div>
                </div>
            </article>
            <article class="col-sm-6 mb-4">
                <div class="d-flex gap-4">
                    ...
                    <div>
                        <h3 class="text-danger" style="font-family: 'Bitter', 'serif'; font-weight: 600">Tasa de interés
                        </h3>
                        <p>La tasa de interés en los créditos de consumo suele ser fija, pero puede variar según la entidad
                            financiera y las condiciones del mercado.</p>
                    </div>
                </div>
            </article>
            <article class="col-sm-6 mb-4">
                <div class="d-flex gap-4">
                    ...
                    <div>
                        ...
                        <p>Algunos créditos de consumo ofrecen opciones de pagos adicionales o la posibilidad de adelantar
                            las cuotas, brindando cierta flexibilidad al deudor.</p>
                    </div>
                </div>
            </article>
            <article class="col-sm-6 mb-4">
