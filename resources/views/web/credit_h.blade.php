        ...
        <article class="col-sm-3" style="z-index: 4">
            <div class="d-flex justify-content-center align-items-center h-100 margin-right-mobile" style="margin-right: -175px;">
                <div class="px-5 py-4 bg-white w-sm-100" style="box-shadow: 10px 11px 8px -5px rgba(0,0,0,0.36);">
                    ...
                    <h2 style="font-family: 'Bitter', 'serif'; color: #676667; font-weight: 600">Créditos <br> Hipotecarios</h2>
                </div>
            </div>
        </article>
        <article class="col-sm-9 d-none-mobile">
            <div class="position-relative">
                ...
                <div class="position-absolute text-center top-50 start-50 translate-middle">
                    <p class="h3 text-white" style="font-family: 'Bitter', 'serif'; font-style: italic">¡Tu Llavel Hacia El Hogar Que Mereces!</p>
...
<section class="container">
    <section class="row py-3">
        <p>Un crédito hipotecario es un préstamo a largo plazo otorgado por una entidad financiera con el propósito específico de adquirir una propiedad inmobiliaria, como una casa o un departamento. Este tipo de crédito está respaldado por una hipoteca, que es una garantía sobre el inmueble adquirido.</p>
    ...
    <section class="row py-3">
        <article class="col-sm-6 mb-4">
            <div class="d-flex gap-4">
                ...
                <div>
                    <h3 class="text-danger" style="font-family: 'Bitter', 'serif'; font-weight: 600">Garantía Hipotecaria</h3>
                    <p class="text-muted" style="font-size: medium">La propiedad que se compra con el préstamo actúa como garantía. En caso de incumplimiento en los pagos, la entidad financiera tiene el derecho de ejecutar la hipoteca y vender la propiedad para recuperar el monto prestado.</p>
                </div>
            </div>
        </article>
        <article class="col-sm-6 mb-4">
            <div class="d-flex gap-4">
                ...
                <div>
                    ...
                    <p>Los créditos hipotecarios suelen tener plazos extensos, generalmente hasta 15. Esto permite a los prestatarios distribuir el costo de la vivienda a lo largo del tiempo, haciendo los pagos más manejables.</p>
                </div>
            </div>
        </article>
        <article class="col-sm-6 mb-4">
            <div class="d-flex gap-4">
                ...
                <div>
                    <h3 class="text-danger" style="font-family: 'Bitter', 'serif'; font-weight: 600">Pagos Mensuales</h3>
                    <p>Los prestatarios realizan pagos mensuales que incluyen una porción del capital prestado y los intereses acumulados. Estos pagos se mantienen constantes en el caso de tasas fijas, pero pueden variar en el caso de tasas variables.</p>
                </div>
            </div>
        </article>
        <article class="col-sm-6 mb-4">
            <div class="d-flex gap-4">
                ...
                <div>
                    <h3 class="text-danger" style="font-family: 'Bitter', 'serif'; font-weight: 600">Requisitos y Evaluación de Solvencia</h3>
                    <p>Para obtener un crédito hipotecario, los solicitantes deben cumplir con ciertos requisitos, como demostrar capacidad de pago, estabilidad laboral y tener un buen historial crediticio.</p>
                </div>
            </div>
        </article>
    </section>
    <section class="row justify-content-center">
        <p>Un crédito hipotecario brinda la oportunidad a las personas de convertirse en propietarios de viviendas sin tener que desembolsar el costo total de la propiedad de inmediato. Sin embargo, es importante comprender completamente los términos y condiciones del préstamo antes de comprometerse, ya que implica una obligación financiera a largo plazo.</p>
        <a class="btn rounded-pill w-auto mt-4" style="background-color: #c61617; color: #ffffff" href="{{ route('web.creditos') }}#calculadora">CALCULAR MI CRÉDITO</a>
    </section>
</section>
