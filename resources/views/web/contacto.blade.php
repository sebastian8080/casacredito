...
@section('head')
    <title>Contáctenos para obtener su crédito | Casa Credito</title>
    <style>
        @keyframes slidein {
            from {
...
@section('content')
    <section class="height-banner-mobile bg-image-banner-mobile" style="height: 750px; background-position: center; background-repeat: no-repeat; background-size: cover; background-image: url('{{ asset('img/banneroficinas.jpg') }}')">
        <section class="height-banner-mobile padding-left-banner-mobile d-flex align-items-center justify-content-start" style="height: 750px; padding-left: 13%">
            <div data-aos="fade-right">
                <h1 style="font-family: 'Bitter', 'serif'; color: #676667"><span style="font-size: 3rem; font-style: italic" class="f-size-min-2">Visita nuestras</span> <br> <span style="font-size: 7rem; font-weight: 600" class="f-size-min-3">oficinas o</span> <br> <span style="font-size: 3rem; font-style: italic" class="f-size-min-2">contáctanos</span> </h1>
    ...
    <section class="container py-5">
        <h2 class="text-center" style="font-family: 'Bitter', 'serif'; font-weight: 700; font-style: italic"><span style="color: #676667">Seleccione la</span> <span style="color: #c61617">oficina más cercana</span></h2>
        <p style="font-family: 'Montserrat', 'serif'; font-size: 20px; color: #676667" class="text-center">Descubra como podemos ayudarlo a alcanzar sus metas económicas</p>
        <section class="d-flex justify-content-center">
            <select id="selOficina" class="form-select rounded-pill w-25 ps-4 border-0" style="font-size: 17px; font-weight: 600; background-color: #eeeeee; color: #c61617">
                ...
                <section class="oficina slidein" id="Cuenca">
                    ...
                    <div class="p-4 mb-3" style="background-color: #f3f3f3">
                        <div class="d-flex align-items-center gap-4">
                            <div style="background-color: #c61617" class="p-3 rounded-circle d-flex justify-content-center align-items-center">
                    ...
                    <div class="p-4 mb-3" style="background-color: #f3f3f3">
                        <div class="d-flex align-items-center gap-4">
                            ...
                            <div>
                                <p class="font-weight-bold my-0" style="font-family: 'Bitter', 'serif';font-weight: 600; font-size: 18px; color: #676667">Horario de atención</p>
                                <p style="font-family: 'Montserrat', 'serif'; font-size: 15px" class="my-0">Lunes a Viernes: 09h00 - 18h00 <br> Sábados: 9h00 - 13h00</p>
                            </div>
                        </div>
                    </div>
                </section>
                <section class="oficina d-none" data-aos="fade-left" id="New York">
                    ...
                    <div class="p-4 mb-3" style="background-color: #f3f3f3">
                        <div class="d-flex align-items-center gap-4">
                            ...
                            <div>
                                <p class="font-weight-bold my-0" style="font-family: 'Bitter', 'serif';font-weight: 600; font-size: 18px; color: #676667">Horario de atención</p>
                                <p style="font-family: 'Montserrat', 'serif'; font-size: 15px" class="my-0">Lunes a Viernes: 09h00 - 18h00 <br> Sábados: 9h00 - 16h00</p>
                            </div>
                        </div>
                    </div>
                </section>
            ...
            <section class="col-sm-7" id="contact_form">
                <article class="d-flex align-items-center" data-aos="fade-left">
                    <div class="p-5 card-cuota-mensual w-100">
                        <h2 class="mb-4" style="font-family: 'Bitter', 'serif';"><span style="color: gray">Enviar Mensaje</span></h2>
                            ...
                            <div>
                                <div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-6 mb-3">
                                                <input class="form-control border-0 rounded-0" style="background-color: #f3f3f3" type="text" placeholder="Nombre" name="name" required>
                                            </div>
                                            <div class="col-sm-6 mb-3">
                                                <input class="form-control border-0 rounded-0" style="background-color: #f3f3f3" type="text" placeholder="Apellido" name="lastname" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-6 mb-3">
                                                <input class="form-control border-0 rounded-0" style="background-color: #f3f3f3" type="number" placeholder="Telefono/Celular" name="phone" required>
                                            </div>
                                            <div class="col-sm-6 mb-3">
                                                <input class="form-control border-0 rounded-0" style="background-color: #f3f3f3" type="email" placeholder="Correo electrónico" name="email" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-6 mb-3">
                                                <select id="selState" class="form-select text-muted border-0 rounded-0" style="background-color: #f3f3f3" name="state" required>
                                            ...
                                            <div class="col-sm-6 mb-3">
                                                <select id="selCity" class="form-select text-muted border-0 rounded-0" style="background-color: #f3f3f3" name="city" required>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-6 mb-3">
                                                <select class="form-select text-muted border-0 rounded-0" style="background-color: #f3f3f3" name="type" required>
                                            ...
                                            <div class="col-sm-6 mb-3">
                                                <input type="number" class="form-control border-0 rounded-0" style="background-color: #f3f3f3" placeholder="Monto a Solicitar" name="mount" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <textarea  id="" rows="4" class="form-control border-0 rounded-0" style="background-color: #f3f3f3" placeholder="Mensaje" name="message" required></textarea>
                                            </div>
                                        </div>
                                    </div>                  
                                </div>
